/*
 * WARNING: This file has been modified by Denis Gorbachev (bug fixes).
 * Update with care (see fixes in git log).
 */
...
Tether = (function(require,exports,module) {
...
(function() {
  ...
  createContext = function(options, defaults) {
    var DropInstance, defaultOptions, defaultDefaults, drop, _name;
    if (options == null) {
      options = {};
    }
    drop = function() {
    ...
    extend(drop.defaults, defaultDefaults, defaults);
